module Admin
  class CarMaintenancesController < AdminBaseController
    ...
    def create
      ...
      respond_to do |format|
        if @car_maintenance.save
          format.html { redirect_to admin_car_maintenance_path(@car, @car_maintenance), notice: "Car maintenance was successfully created." }
    ...
    def update
      respond_to do |format|
        if @car_maintenance.update(car_maintenance_params)
          format.html { redirect_to admin_car_maintenances_path, notice: "Car maintenance was successfully updated." }
    ...
    def destroy
      ...
      respond_to do |format|
        format.html { redirect_to admin_car_maintenances_path, status: :see_other, notice: "Car maintenance was successfully destroyed." }
