class CarsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @car.save
        format.html { redirect_to cars_path, notice: "#{t('views.item.car')} #{t('views.flash.notice_created')}." }
  ...
  def update
    respond_to do |format|
      if @car.update(car_params)
        format.html { redirect_to cars_path, notice: "#{t('views.item.car')} #{t('views.flash.notice_updated')}." }
